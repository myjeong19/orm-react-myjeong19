...
const List = React.lazy(() => import('../pages/Article/List'));
const Modify = React.lazy(() => import('../pages/Article/Modify'));
const Regist = React.lazy(() => import('../pages/Article/Regist'));
const Detail = React.lazy(() => import('../pages/Article/Detail'));
...
const authProtectedRoutes = [
  ...
  { path: '/article/regist', component: <Regist /> },
  { path: '/article/detail', component: <Detail /> },
  { path: '/article/modify/:aidx', component: <Modify /> },
];
